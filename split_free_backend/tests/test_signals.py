...
from split_free_backend.core.models import Balance, Debt, Expense, Group, Member, User
from split_free_backend.core.signals import handle_group_created
...
class GroupSignalTests(BaseAPITestCase):
    ...
    def test_handle_group_updated_signal_added_members(self):
        ...
        for member in new_members:
            self.assertEqual(Balance.objects.get(group=self.group, owner=member).amount, 0.00)
